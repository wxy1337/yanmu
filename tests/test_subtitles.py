...
class SubtitleTests(unittest.TestCase):
    ...
    def test_long_speech_keeps_its_full_time_range(self) -> None:
        segment = SubtitleSegment(10.0, 42.0, "Continuous speech")
        self.assertEqual(subtitle_display_end(segment), 42.0)
        result = render_srt([segment], bilingual=False)
        self.assertIn("00:00:10,000 --> 00:00:42,000", result)
    ...
    def test_ass_timestamp_preserves_speech_end(self) -> None:
        result = render_ass([SubtitleSegment(1.0, 20.0, "Hello")], bilingual=False)
        self.assertIn("Dialogue: 0,0:00:01.00,0:00:20.00", result)
